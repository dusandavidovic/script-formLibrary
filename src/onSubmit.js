...
function onFormSubmit(e) {
  ...
  Logger.log("onFormSubmit - %s", formTitle);
...
/* Execution script *********************/
var VAR_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxcGG3o96TYM_EBve7P4svSuUdtJ95slf1gG2Tzxyh9ZH1TFrg/exec";
...
function getResponse( e ) {
  ...
  if (typeof e == 'undefined' ) { //TEST ONLY
